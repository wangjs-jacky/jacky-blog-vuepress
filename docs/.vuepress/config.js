...
module.exports = {
  ...
  head: [
    ...
    [
      'meta',
      {
        name: 'keywords',
        content:
          '有志者、事竟成，破釜沉舟，百二秦zhi关终属楚；下联：苦心人、天不负，卧薪尝胆，三千越甲可吞吴。'
      }
    ],
  ...
  themeConfig: {
    ...
    //     'img/火山.jpg',
    //     'img/披萨.jpg',
    //     'https://wjs-tik.oss-cn-shanghai.aliyuncs.com/img/皮卡丘.jpg',
    //     'https://wjs-tik.oss-cn-shanghai.aliyuncs.com/img/5bcae766b9d5e.jpg'
    // ],
    ...
    author: {
      ...
      name: 'wangjiasheng', // 必需
      link: 'https://github.com/wangjs-jacky' // 可选的
    },
    blogger: {
      // 博主信息，显示在首页侧边栏
      avatar: './img/古风头像.jpg',
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:2409277719@qq.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/wangjs-jacky'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://music.163.com/#/playlist?id=642386905'
        }
      ]
    },
    footer: {
  ...
  plugins: [
    ...
    //       owner: 'wangjs-jacky', // GitHub仓库所有者
    //       admin: ['wangjs-jacky'], // 对仓库有写权限的人
